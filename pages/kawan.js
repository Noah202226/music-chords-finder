...
export default function Kawan() {
  ...
  const worshipColRef = collection(fs, "kawanMeeting");
  ...
  const changeWorship1 = (img) => {
    setChange1(true);
    setDoc(doc(fs, "kawanMeeting", "song1"), {
  ...
  const changeWorship2 = (img) => {
    setChange2(true);
    setDoc(doc(fs, "kawanMeeting", "song2"), {
      imageName: img.data.imageName,
      url: img.data.url,
    })
      .then((data) => {
  ...
  const changeWorship3 = (img) => {
    setChange3(true);
    setDoc(doc(fs, "kawanMeeting", "song3"), {
      imageName: img.data.imageName,
      url: img.data.url,
    })
      .then((data) => {
  ...
  return (
    <Box>
      ...
      <Grid
        container
        sx={{ padding: 1, backgroundColor: green[200], marginBottom: 1 }}
        spacing={0.5}
      >
        <Grid item md={6}>
          <Stack>
            <Typography>ANG GAWA NI JESUS</Typography>

            <Image
              src="https://firebasestorage.googleapis.com/v0/b/music-ministry-chord-finder.appspot.com/o/images%2F313218340_1312685172833005_7793888877734388783_n.jpg971f1401-2eaf-434f-ae21-88f494027a30?alt=media&token=2c7cff58-bd5e-470d-8722-7ee8f2675841"
              alt={logo}
              width={100}
              height={100}
            />
        ...
        <Grid item md={6}>
          <Stack>
            <Typography>Salamat, Salamat</Typography>

            <Image
              src="https://firebasestorage.googleapis.com/v0/b/music-ministry-chord-finder.appspot.com/o/images%2FSalamat%2C%20Salamat.jpgdd276414-c70b-4c69-9ab6-d4574879376f?alt=media&token=e8a102e7-1b75-4f47-b6ad-35bfc7720b67"
              alt={tinapayNgBuhay}
              width={100}
              height={100}
            />
